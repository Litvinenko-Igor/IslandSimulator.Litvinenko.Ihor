...
public class Mouse extends Herbivore{
    private static final double BASE_WEIGHT = 0.05; // Базова вага виду
    private static final int MAX_COUNT_PER_CELL = 500; // Макс. на клітинці
    private static final int MAX_SPEED = 1; // Макс. швидкість (клітинок за хід)
    private static final double FOOD_CAPACITY = 0.01; // Потрібно їжі для насичення
