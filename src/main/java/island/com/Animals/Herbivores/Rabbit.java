...
public class Rabbit extends Herbivore {
    private static final double BASE_WEIGHT = 2.0; // Базова вага виду
    private static final int MAX_COUNT_PER_CELL = 150; // Макс. на клітинці
    private static final int MAX_SPEED = 2; // Макс. швидкість (клітинок за хід)
    private static final double FOOD_CAPACITY = 0.45; // Потрібно їжі для насичення
